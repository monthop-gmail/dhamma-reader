...
function App() {
    ...
    const fontOptions = [
        ...
        { id: 'THSarabunNew_normal', label: 'TH Sarabun (Normal)' },
        { id: 'KaLaTeXa Text', label: 'KaLaTeXa Text' },
        { id: 'KaLaTeXa Display', label: 'KaLaTeXa Display' },
        { id: 'Sarabun', label: 'Sarabun (Default)' }
    ];
